...
tests! {
    ...
    Vec::<()>::with_capacity: fn(uint) -> Vec<()> /(5);
    Vec::from_fn: fn(uint, fn(uint) -> uint) -> Vec<uint> /(5, id);
    Vec::<uint>::from_fn: fn(uint, fn(uint) -> uint) -> Vec<uint> /(5, id);
    Vec::from_fn::<fn(uint) -> uint>: fn(uint, fn(uint) -> uint) -> Vec<uint> /(5, id);
    Vec::<uint>::from_fn::<fn(uint) -> uint>: fn(uint, fn(uint) -> uint) -> Vec<uint> /(5, id);
